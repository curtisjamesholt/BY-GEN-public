...
#    < Operators >
# //====================================================================//
#////////// OPERATORS FOR BRANCHED GENERATION >
...
class BYGEN_OT_Branched_Generation(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        #Prepare radian vars for euler angle rotations
        r90 = 1.570796
        r180 = 3.141593
...
def generate_cells():
    ...
    if cell_count >= maxModules:
        pass
        #print("Ended generation due to maxModules count.")
